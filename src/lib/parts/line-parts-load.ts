// Loads the inputs for ./line-parts.ts and resolves per entry: which
...
//
// Relative imports + DbClient parameter on purpose — the analyst bundle
// reads this under the tsx eval script; the request path goes through
// db/queries/line-parts.ts.
...
export async function loadResolvedLineParts(
  db: DbClient,
  entryIds: string[],
