...
- Every finding fills fields — the filed-vs-expected diff a broker would correct from. Each row is a short field label with the value as declared and the value you expect, in human form: filed "not declared" / expected "$2,572.50 at 10%", filed "A-570-133" / expected "A-570-121". Dollar or rate expectations must come from tool outputs. Use null for a side that has no expressible value, and an empty list only when the finding is a pure observation with no filed/expected framing.
