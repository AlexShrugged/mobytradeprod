...
// kind a compile error, not a silent stub. On Vercel the stub is refused
// for every kind — it fabricates documents, and manual_upload never
// legitimately runs a connector.
